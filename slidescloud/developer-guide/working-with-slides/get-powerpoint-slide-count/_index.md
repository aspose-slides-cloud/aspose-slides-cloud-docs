...
## **Resource**
The following Aspose.Slides for Cloud REST API resource has been used in the examples: [Slides](/pages/createpage.action?spaceKey=slidescloud&title=Slides&linkCreation=true&fromPageId=5046477).
