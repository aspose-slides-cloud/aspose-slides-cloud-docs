...
This article shows you how to add a SmartArt graphic to a PowerPoint presentation using Aspose.Slides Cloud in your applications. The code examples in this article use `CreateShape` method described in [Adding Shapes to a PowerPoint Presentation](/slides/add-a-shape-to-a-slide/) method.
