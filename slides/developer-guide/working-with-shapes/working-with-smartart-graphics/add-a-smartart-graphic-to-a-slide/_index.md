...
keywords: "PowerPoint, presentation, REST API, Cloud API, SmartArt, create SmartArt, add SmartArt"
type: docs
...
This article shows you how to add a SmartArt graphic to a PowerPoint presentation using Aspose.Slides Cloud in your applications. The code examples in this article use `CreateShape` method described in [Add a Shape to a Slide](/slides/add-a-shape-to-a-slide/) method.
