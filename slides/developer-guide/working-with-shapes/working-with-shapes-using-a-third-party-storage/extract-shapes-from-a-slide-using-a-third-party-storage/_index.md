...
This article shows you how to extract shapes from a slide in PowerPoint presentation saved to third-party storage. The code examples below use `GetShapes` method described in [Extract Shapes from a Slide](/slides/get-shapes-from-a-slide/).

{{% alert color="primary" %}}

You need to configure third-party storage with Aspose Cloud before using these examples. Follow the instructions at [this page](https://docs.aspose.cloud/storage/how-to-configure-3rd-party-cloud-storages/) to configure your required storage.
