...
{{< tabs tabTotal="2" tabID="2" tabName1="Requests" tabName2="Responses" >}}
...
Convert **MyPresentation.pptx** presentation to PDF document. The document should only contain the slides with indexes **2** and **4**.
...
Create **MyFonts** storage folder in **Main** storage, add **custom.ttf** font to the folder, convert **example.pptx** presentation to PDF document.

{{< tabs tabTotal="11" tabID="6" tabName1="C#" tabName2="Java" tabName3="PHP" tabName4="Ruby" tabName5="Python" tabName6="Node.js" tabName7="Android" tabName8="C++" tabName9="Perl" tabName10="Swift" tabName11="Go" >}}
...
$response = $slidesApi->convert($fileStream, ExportFormat::PDF, null, $storageName, $fontFolderName, null, null);
...
pdf_data = slides_api.convert(file_data, ExportFormat::PDF, nil, storage_name, font_folder_name)
...
with open("example.pptx", "rb") as file_stream:
    pdf_path = slides_api.convert(file_stream, ExportFormat.PDF, None, storage_name, font_folder_name)
