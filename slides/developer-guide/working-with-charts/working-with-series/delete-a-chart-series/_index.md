...
## **Introduction**
Aspose.Slides Cloud allows you to delete a chart series from a PowerPoint presentation.
...
Chart chart = api.DeleteChartSeries("myPresentaion.pptx", 3, 1, 2);
...
```java
SlidesApi api = new SlidesApi("MyClientId", "MyClientSecret");
Chart chart = (Chart)api.deleteChartSeries("MyPresentation.pptx", 3, 1, 2, null, null, null);
...
$result = $api->DeleteChartSeries("MyPresentation.pptx", 3, 1, 2);
...
result = api.delete_chart_series("MyPresentation.pptx", 3, 1, 2)
...
result, _, e := api.SlidesApi.DeleteChartSeries("MyPresentation.pptx", 3, 1, 2, "", "", "")
if e != nil {
