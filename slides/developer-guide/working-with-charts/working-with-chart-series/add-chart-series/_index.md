...
Chart chart = (Chart)api.createChartSeries("MyPresentation.pptx", 1, 2, dto, null, null, null);
...
$result = $api->CreateChartSeries("MyPresentation.pptx", 1, 2, $dto);
...
result = api.create_chart_series("MyPresentation.pptx", 1, 2, dto)
...
return api.createChartSeries("MyPresentation.pptx", 1, 2, dto).then((result) => {
...
result, _, e := c.SlidesApi.CreateChartSeries("MyPresentation.pptx", 1, 2, dto, "", "", "")
if e != nil {
