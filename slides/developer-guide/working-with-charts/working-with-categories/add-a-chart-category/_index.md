...
## **Introduction**
Aspose.Slides Cloud allows you to add chart categories to a PowerPoint presentation. You provide data points that will be added to a respective data series for the category.
