...
- [Read an Animation](/slides/read-an-animation/)
- [Update an Interactive Sequence](/slides/update-an-interactive-sequence/)
- [Update a Main Sequence](/slides/update-a-main-sequence/)
- [Working with an Animation on a Special Slide](/slides/working-with-an-animation-on-a-special-slide/)
- [Working with a Paragraph Animation](/slides/working-with-a-paragraph-animation/)
