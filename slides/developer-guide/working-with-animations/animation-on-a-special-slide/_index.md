...
|/slides/{name}/slides/{slideIndex}/{slideType}/animation/mainSequence/{effectIndex}|DELETE|Delete an effect from a main sequence on a special slide|[DeleteSpecialSlideAnimationEffect](https://reference.aspose.cloud/slides/#/SpecialSlideAnimation/DeleteSpecialSlideAnimationEffect)|
...
|/slides/{name}/slides/{slideIndex}/{slideType}/animation/interactiveSequences/{sequenceIndex}|DELETE|Delete an interactive sequence from a special slide|[DeleteSpecialSlideAnimationInteractiveSequence](https://reference.aspose.cloud/slides/#/SpecialSlideAnimation/DeleteSpecialSlideAnimationInteractiveSequence)|
