...
curl  -v -X GET "https://api.aspose.cloud/v3.0/slides/presentation_images.pptx/slides/1/theme" -H "Content-Type: application/json" -H "Authorization: Bearer [Authentication code]" --ssl-no-revoke
